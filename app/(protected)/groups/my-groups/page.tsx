...
import { Search, Users, Calendar, BookOpen, MessageCircle, Loader2 } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            {isLoading ? (
                ...
                <div className="text-center py-12">
                    ...
                    <Link href="/groups">
                        <Button className="bg-indigo-600 hover:bg-indigo-700 text-white">Browse Groups</Button>
                    </Link>
                </div>
            ) : (
